...
<%
    ...
    if (it2.hasNext())
    {
        ...
        stateList.append("<table border='1' cellpadding='5' cellspacing='0' width='100%'><tr><th colspan='2' align='left' valign='top' nowrap>States</th></tr><tr><td valign='top' nowrap>");
...
<table summary="Links to potential partner list" bgcolor="white" border="1" cellpadding="5" cellspacing="0" width="100%">
<tr>
