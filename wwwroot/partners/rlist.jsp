    ...
    if (rs.next())
    {
        ...
        do
        {
           ...
           // }
			...
			if (region.compareTo(rs.getString("abbreviation")) == 0)
				stateList.append("<font style='font-family : Verdana, Geneva, Arial, Helvetica, sans-serif;	font-size : 14px;	font-weight: bold; color : #FF0000;'>"+rs.getString("name").trim()+"</font>");
			else
