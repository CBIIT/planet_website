...
if (it2.hasNext()) {
        ...
        stateList.append("<table border='0' cellpadding='5' cellspacing='0' width='100%'><tr><th colspan='2' align='left' valign='top' width='100%'>States</th></tr><tr><td colspan=2><a href='rlist.jsp?r=ALL&cctopic=" + topic + "' title=\"All states and regions\">View all U.S. Research Partners</a></td></tr><tr><td valign='top' nowrap>");
		String typeString = "S";
        int count= 0;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td><p><a href="../index.html">Home</a><br>
        ...
        <a href="/cgi-bin/awredir.pl?url=http://ccplanetraining.cancer.gov" onClick="javascript:popWindow('/cgi-bin/awredir.pl?url=http://secure.mmgct.com/planettraining/', 'name','725','400','yes'); return false;">On-line Training</a><br />
