    ...
    if (rs.next())
    {
        ...
        do
        {
           ...
           // }
			...
			if (region.compareTo(rs.getString("abbreviation")) == 0)
				stateList.append("<font style='font-family: Verdana, Geneva, Arial, Helvetica, sans-serif;font-size: 10;font-weight: normal;color: 000000;'>"+rs.getString("name").trim()+"</font>");
			else
...
<tr>
	<td valign='top'>
		...
		<tr>
			...
			<td width="50">&nbsp;</td>
			<td valign="top" style="font-family : Verdana, Geneva, Arial, Helvetica, sans-serif;	font-
			size : 14px;	font-weight: bold; color : #000000;" width="250"><a href="list.jsp?r=<%= 
			region%>&cctopic=C">View Program Partners in <%= stateStatic%></a>
			</td>
		</tr>
		</table>
	</td>
