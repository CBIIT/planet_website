...
<%
    ...
    if (it2.hasNext())
    {
        ...
        stateList.append("<table border='1' cellpadding='0' cellspacing='0'><tr><th colspan='2' align='left' valign='top' nowrap bgcolor='#F1F1FD'>STATES</th></tr><tr><td valign='top' nowrap  bgcolor='#F1F1FD'>");
