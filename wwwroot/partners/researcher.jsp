...
<%
    ...
    if (it2.hasNext())
    {
        ...
        stateList.append("<table border='0' bgcolor='#F1F1FD' cellpadding='5' cellspacing='0'><tr><th colspan='2' align='left' valign='top' nowrap>STATES</th></tr><tr><td valign='top' nowrap>");
...
<table summary="Links to potential partner list" bgcolor="white" border="0" cellpadding="0" cellspacing="0">
<tr>
