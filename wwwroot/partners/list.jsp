    ...
    if (rs.next())
    {
        ...
        do
        {
            if (stateName.compareTo(rs.getString("state_name").trim()) != 0)
            {
                ...
                outString.append("<p><font style='font-family: Verdana, Geneva, Arial, Helvetica, sans-serif;font-size: 14;font-weight: bold;color: #000000;'>View Cancer Control Partners in another state / territory:</font></p>");
