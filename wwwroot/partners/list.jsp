...
topicNum = QBean.getTopicID(topic);
    ...
    if (partners!=null)
    {
        ...
        do
        {
            ...
            if (stateName.compareTo(rs.getStateName().trim()) != 0)
            {
				...
				typeDesc = rs.getTypeDescription();
                outString.append("<table border='1' cellspacing='0' cellpadding='0' width='80%'>");
            ...
            if (partnerId != rs.getPartnerId())
            {
                ...
                typeString = rs.getType();
				typeDesc = rs.getTypeDescription();
                outString.append("<p><table border='1' cellspacing='0' cellpadding='0' width='80%'>");
    ...
    if (it2.hasNext())
    {
        ...
        stateList.append("<table border='0' cellpadding='5' cellspacing='0'><tr><th colspan='2' align='left' valign='top'>STATES</th></tr><tr><td valign='top' nowrap>");
		String typeString = "S";
        int count= 0;
