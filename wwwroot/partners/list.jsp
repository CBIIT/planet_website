...
topicNum = QBean.getTopicID(topic);
    ...
    if (it2.hasNext())
    {
        ...
        stateList.append("<table border='0' cellpadding='5' cellspacing='0' width='100%'><tr><th colspan='2' align='left' valign='top' width='100%' bgcolor='#F1F1FD'>STATES</th></tr><tr><td valign='top' nowrap bgcolor='#F1F1FD'>");
		String typeString = "S";
        int count= 0;
