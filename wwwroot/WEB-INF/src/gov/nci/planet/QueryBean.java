...
public class QueryBean {
	...
	public String getTopicDescription(String topic) {
		...
		String topicTitle = "";
		if (PlanetParameterValidator.validatePartnerTopic(topic)) {
			ResultSet rs = null;
			Connection conn =null;
			CallableStatement stmt =null;
	...
	public String getTopicID(Integer topicIN) {
		String topicID = null;
		if (PlanetParameterValidator.validateResearcherTopic(topicIN)) {
			ResultSet rs = null;
			Connection conn =null;
			CallableStatement stmt =null;
	...
	public int getTopicID(String topicIN) {
		int topicID = 0;
		if (PlanetParameterValidator.validatePartnerTopic(topicIN)) {
			ResultSet rs = null;
			Connection conn =null;
			CallableStatement stmt =null;
	...
	public Vector getCountbyPartner(String stateAbbreviation) {
		Vector partnercounts = null;
		if (PlanetParameterValidator.validateStateAbbreviation(stateAbbreviation)) {
			ResultSet rs = null;
			Connection conn = null;
			CallableStatement stmt = null;
	...
	public Vector getPartners(String topic, String stateAbbreviation) {
		...
		if (PlanetParameterValidator.validateStateAbbreviation(stateAbbreviation)
				&& PlanetParameterValidator.validatePartnerTopic(topic)) {
			ResultSet rs = null;
			Connection conn =null;
			CallableStatement stmt =null;
	...
	public String getTopicDescription(Integer topic) {
		String desc = "";
		if (PlanetParameterValidator.validateResearcherTopic(topic)) {
			ResultSet rs = null;
			Connection conn =null;
			CallableStatement stmt =null;
	...
	public Vector getResearchers(Integer topic, String stateAbbreviation) {
		...
		if (PlanetParameterValidator.validateResearcherTopic(topic) 
				&& PlanetParameterValidator.validateStateAbbreviation(stateAbbreviation)) {
			ResultSet rs = null;
			Connection conn =null;
			CallableStatement stmt =null;
