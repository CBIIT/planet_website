...
<td valign="top">Contact information for ACS, CDC, NCI, and CoC  program  and research partners by state and region</td>
        ...
        <tr>
          <td valign="top">&nbsp;</td>
          <td valign="top" class="smaller" colspan="2"><a title="External link" href="/cgi-bin/awredir.pl?url=http://www.cdc.gov/cancer/ncccp/ccc_plans.htm" onClick="javascript:popWindow('/cgi-bin/awredir.pl?url=http://www.cdc.gov/cancer/ncccp/ccc_plans.htm', 'name','925','600','yes'); return false;">Comprehensive Cancer Control Plans<img src="images/Icon_External_Link.png" alt="External link" width="12" height="12" border="0"></a></td>
        </tr>
        <tr>
          <td valign="top">&nbsp;</td>
